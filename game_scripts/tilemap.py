...
class Tilemap(pygame.sprite.Sprite):
    def __init__(self, calculation_of_coordinates, pos, type_of_tile, varint_of_tile, sprite_group, other_sprite_group, all_sprites):
        ...
        if calculation_of_coordinates == 'tilemap':
            size_tile = [16, 16]
            increase = 2.5
            self.image = pygame.transform.scale(load_image(f"images/tiles/{type_of_tile}/{varint_of_tile}.png"), (size_tile[0] * increase, size_tile[1] * increase))
